...
api_router.include_router(clean_database.router, prefix="/setup", tags=["Database"])
api_router.include_router(add_ext_ontology.router, prefix="/setup", tags=["Setup"], deprecated=True)
api_router.include_router(initiate_database.router, prefix="/setup", tags=["Database"])
