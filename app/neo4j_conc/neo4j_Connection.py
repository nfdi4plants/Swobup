...
class Neo4j_Connection:
    ...
    async def write_to_neo4j(self,batch_queries):
        ...
        async with AsyncGraphDatabase.driver(uri, auth=(self.username, self.password), max_connection_lifetime=3600) as driver:
    ...
    def add_templates(self, data):
        ...
        for i in range(0, len(data), self.batch_size):
            ...
            asyncio.run(self.write_to_neo4j(batch_queries))