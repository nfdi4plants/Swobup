...
class Neo4jConnection:
    ...
    def set_constraints(self):
        self.query('CREATE CONSTRAINT IF NOT EXISTS FOR (o:Ontology) REQUIRE o.name IS UNIQUE')
        self.query('CREATE CONSTRAINT IF NOT EXISTS FOR (t:Term) REQUIRE t.accession IS UNIQUE')
        self.query('CREATE CONSTRAINT IF NOT EXISTS FOR (t:Template) REQUIRE t.id IS UNIQUE')
