...
const StatusInformation = async () => {
  ...
  // do something with myJson
  console.log(responseJson)
  document.getElementById("number_terms").innerHTML = responseJson.number_terms;
  document.getElementById("number_ontologies").innerHTML = responseJson.number_ontologies;
  document.getElementById("number_relationships").innerHTML = responseJson.number_relationships;
